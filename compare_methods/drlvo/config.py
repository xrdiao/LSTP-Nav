...
from project_paths import DRLVO_CHECKPOINT_DIR, DRLVO_RUNS_DIR, TURTLEBOT_URDF_PATH

URDF_PATH = TURTLEBOT_URDF_PATH
...
class DrlVOConfig:
    ...
    model_dir: Path = DRLVO_CHECKPOINT_DIR
    log_dir: Path = DRLVO_RUNS_DIR
